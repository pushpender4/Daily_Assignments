...
<body style="background-color:#212529;">
    ...
    ?>
    <script>
        // Check if the page is loaded as a result of a POST request
        if (window.performance && window.performance.navigation.type === 1) {
            // Page loaded via link or a direct URL, not a page refresh
            // Redirect to the same page to avoid displaying the previous result
